...
<head>
   ...
   <style>
     ...
     .btn:hover {
         ...
         <div class="header_section" style="background-color: rgba(0, 0, 0, 0.9);">
           <div class="container-fluid">
            ...
            <div class="col-sm-4">
               ...
               <div class="row">
                  <div class="col-sm-12">
                     <input type="text" id="busqueda" oninput="buscar()" autofocus class="form-control" placeholder="Buscar...">
                  </div>
               </div>
            </div>
            <div class="col-sm-4">
      ...
      <div class="banner_section layout_padding" style="background-image: url('images/background.jpeg'); background-size: cover; background-attachment: fixed;">
