				...
				<div class="container"><br>
					<div class="card">
						...
						<div class="card-body">
							...
							Ingrese su nueva contraseña con la que ingresará a MaFeKa <br><br>
							<div class="form-group">
								<input type="text" id="email" style="display: none;" value="<?php echo $_GET['id'] ?>">
								<input type="password" class="email-bt" oninput="validarcontra()"  placeholder="Nueva Contraseña" name="Email" id="pass">
								<span id="passstrength"></span>
							</div>
							<center><div class="g-recaptcha" data-sitekey="6LeJrzMgAAAAAArZWJV8RP2SVOrBD4D3MTRdsnbw"></div></center><br>
							<div id="respu"></div>
							<center>
								<button class="btn btn-outline-primary" id="login" onclick="cambiar()">Solicitar</button>
							</center>
						</div>
					</div>
