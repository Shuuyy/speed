			...
			<div class="col-sm-8">
				<div class="container"><br>
					<div class="card">
						...
						<div class="card-body">
							Ingrese su correo electrónico registrado con nosotros, a continuación recibirá un código que ingresará <a href="">aquí</a> para restablecer su contraseña <br><br>
							...
							<div id="respu"></div>
							<center>
								<button class="btn btn-outline-primary" id="login" onclick="login()">Solicitar</button>
							</center>
					...
					<div class="container">
						<div style="text-align: right;">
							<a href="cambio.php">Ya tengo el código</a>
						</div>
					</div>
				</div> 
			</div>
